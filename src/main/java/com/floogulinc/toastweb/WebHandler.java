...
import com.floogulinc.toastweb.api.API;
import com.floogulinc.toastweb.controller.ConfigController;
import com.floogulinc.toastweb.controller.Controller;
import com.floogulinc.toastweb.controller.IndexController;
import com.floogulinc.toastweb.websockets.SocketConfig;
import com.floogulinc.toastweb.websockets.SocketLogger;
...
public class WebHandler {
    ...
    public static void init() {
        ...
        pref = new ModuleConfig("ToastWeb");
        ...
        hb.registerHelper("import", (ctx, opt) -> {
            ...
            if (ctx instanceof HashMap)
                hm.putAll((Map<? extends String, ?>) ctx);
    ...
    public static String resource(String name) {
        try (BufferedReader reader = new BufferedReader(
                new InputStreamReader(WebHandler.class.getResourceAsStream("/floogulinc/toastweb/" + name)))) {
            String ln;
            String total = "";
    ...
    public static byte[] resourceRaw(String name) {
        try (InputStream in = WebHandler.class.getResourceAsStream("/floogulinc/toastweb/" + name)) {
